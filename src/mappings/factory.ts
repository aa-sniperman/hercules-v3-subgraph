...
import { ADDRESS_ZERO, FACTORY_ADDRESS, ONE_BI, pools_list, ZERO_BD, ZERO_BI } from './../utils/constants'
...
export function handlePoolCreated(event: PoolEvent): void {
  ...
  if (factory == null) {
    ...
    factory.totalVolumeMetis = ZERO_BD
    factory.totalVolumeUSD = ZERO_BD
    factory.untrackedVolumeUSD = ZERO_BD
    factory.totalFeesUSD = ZERO_BD
    factory.totalFeesMetis = ZERO_BD
    factory.defaultCommunityFee = ZERO_BI
    factory.totalValueLockedMetis = ZERO_BD
    factory.totalValueLockedUSD = ZERO_BD
    factory.totalValueLockedUSDUntracked = ZERO_BD
    factory.totalValueLockedMetisUntracked = ZERO_BD
    factory.txCount = ZERO_BI
    factory.owner = ADDRESS_ZERO

    // create new bundle for tracking matic price
    let bundle = new Bundle('1')
    bundle.metisPriceUSD = ZERO_BD
    bundle.save()
  }
